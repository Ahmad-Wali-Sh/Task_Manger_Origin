...
//                 setTroubleshoot({address: item.address }),
//                 setTroubleshoot({contact: item.contact}),
//                 setTroubleshoot({problem: item.problem}),
//                 setTroubleshoot({service_charge: item.service_charge}),
//                 setTroubleshoot({description: item.description})
//             ))           
//   }, [])
  ...
  function TroubleshootSubmit(e) {
    ...
    //       axios({
    //           method: "Patch",
    //           url: "http://192.168.60.55:8000/api/taskmanager/linkDetails/",
