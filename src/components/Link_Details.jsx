...
export default function Link_Details(props) {
  ...
  React.useEffect(() => {
    axios.get(process.env.REACT_APP_INSTALL + `?id=${props.id}`).then((res) => {
      setInstallation(res.data.results);
      setLink(res.data.results.map((item) => item.link_details));
  ...
  React.useEffect(() => {
    axios.get("http://192.168.60.55:8000/api/taskmanager/linkDetails/" + `?id=${props.id}`).then((res) => {
          ...
          <div className="card bg-light mb-3 mt-3">
            ...
            <div className="card-body">
              ...
              <div className="row">
                ...
                <div className="col-2"></div>
                <div className="col-5">
                  <label htmlFor="device" className="col-form-label text-muted">
                    Device
                  </label>
                  <input
                    type="text"
              ...
              <div className="row">
                ...
                <div className="col-2"></div>
                <div className="col-5">
                  <label htmlFor="signal" className="col-form-label text-muted">
                    Signal
                  </label>
                  <input
                    type="text"
              ...
              <div className="row">
                ...
                <div className="col-2"></div>
                <div className="col-5">
                  <label htmlFor="cable" className="col-form-label text-muted">
                    Cable
                  </label>
                  <input
                    type="text"
